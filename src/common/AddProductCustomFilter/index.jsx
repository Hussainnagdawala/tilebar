...
const CommonFilterComponent = React.memo(
  ({
    initialData = [],
    initialSelectedData = [],
    onSelectionChange = () => {},
  ...
  // Compare props to avoid re-renders
  // (prevProps, nextProps) =>
  //   JSON.stringify(prevProps.initialSelectedData) ===
  //     JSON.stringify(nextProps.initialSelectedData) &&
