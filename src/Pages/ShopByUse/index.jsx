...
const Index = () => {
  ...
  const shopByUsecolumns = [
    ...
    },
    {
      ...
      selector: (row) =>
        <img src={row?.image} alt={"shop-by-use-image"} width={"150px"} /> ||
        "",
    },
  ...
  const handleGetShopByUseData = async () => {
    try {
      const response = await service.shopByUsePage.listing();
          ...
          >
            ...
            <Stack>
              <Typography variant="body2" color={colors.darkGray.main} py={4}>
                Once deleted, it will be permanently removed from the system and
                cannot be recovered. Please confirm your action.
              </Typography>
            </Stack>
