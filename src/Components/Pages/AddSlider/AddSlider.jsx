        ...
        <div className="container">
          ...
          <div className="row mb-3 mt-2 align-items-center">
            <div className="col-sm-6">
              <h1 className="m-0 text-dark">All Sliders</h1>
            </div>
            <div className="col-sm-6">
              <ol className="breadcrumb float-sm-right">
                ...
                <li className="breadcrumb-item active">All Sliders</li>
              </ol>
            </div>
          </div>
      ...
      <Modal show={show} onHide={handleClose} animation={false}>
        ...
        <Modal.Body>
          {/* Add your form fields or other content here */}
           <form action="">
           <div class="mb-3">
           <label htmlForfor="exampleFormControlInput1" className="form-label">Add Slider</label>
